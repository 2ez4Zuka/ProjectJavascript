...
const productoHTML = document.getElementsByClassName("producto");

const Electronico = document.getElementsByClassName("Electronico");
const Animales = document.getElementsByClassName("Animales");
const Cocina = document.getElementsByClassName("Cocina");
